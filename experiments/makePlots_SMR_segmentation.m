function makePlots_SMR_segmentation(resultFileName)
% makePlots_SMR_segmentation plots fig.4a from the journal paper
...
curSteps = findClosest(dataPlotX{curPlotIndex}, [2, 5 : 7.5 : 29]);
...
curSteps = findClosest(dataPlotX{curPlotIndex}, [.8, 9 : 7.5: 29]);
markerPlotX{curPlotIndex} = dataPlotX{curPlotIndex}(curSteps);
markerPlotY{curPlotIndex} = dataPlotY{curPlotIndex}(curSteps);
...
curSteps = findClosest(dataPlotX{curPlotIndex}, [.8, 7.5 :  7.5 : 29]);
markerPlotX{curPlotIndex} = dataPlotX{curPlotIndex}(curSteps);
markerPlotY{curPlotIndex} = dataPlotY{curPlotIndex}(curSteps);
...
curSteps = findClosest(dataPlotX{curPlotIndex}, [.8, 6 :  7.5 : 29]);
markerPlotX{curPlotIndex} = dataPlotX{curPlotIndex}(curSteps);
markerPlotY{curPlotIndex} = dataPlotY{curPlotIndex}(curSteps);
...
curSteps = findClosest(dataPlotX{curPlotIndex}, [.8, 4.5 :  7.5 : 29]);
markerPlotX{curPlotIndex} = dataPlotX{curPlotIndex}(curSteps);
markerPlotY{curPlotIndex} = dataPlotY{curPlotIndex}(curSteps);
...
curSteps = findClosest(dataPlotX{curPlotIndex}, [.8, 3 :  7.5 : 29]);
markerPlotX{curPlotIndex} = dataPlotX{curPlotIndex}(curSteps);
markerPlotY{curPlotIndex} = dataPlotY{curPlotIndex}(curSteps);
...
curSteps = findClosest(dataPlotX{curPlotIndex}, [.8, 8.5 : 7.5 : 29]);
markerPlotX{curPlotIndex} = dataPlotX{curPlotIndex}(curSteps);
markerPlotY{curPlotIndex} = dataPlotY{curPlotIndex}(curSteps);
markerType{curPlotIndex}= 'o';
...
curSteps = findClosest(dataPlotX{curPlotIndex}, [.8, 7.0 :  7.5 : 29]);
markerPlotX{curPlotIndex} = dataPlotX{curPlotIndex}(curSteps);
markerPlotY{curPlotIndex} = dataPlotY{curPlotIndex}(curSteps);
markerType{curPlotIndex} = 's';
markerColor{curPlotIndex} = 'b';
...
curSteps = findClosest(dataPlotX{curPlotIndex}, [.8, 5.5 :  7.5 : 29]);
markerPlotX{curPlotIndex} = dataPlotX{curPlotIndex}(curSteps);
markerPlotY{curPlotIndex} = dataPlotY{curPlotIndex}(curSteps);
markerType{curPlotIndex}= '^';
markerColor{curPlotIndex} = 'b';
...
curSteps = findClosest(dataPlotX{curPlotIndex}, [.8, 4 :  7.5 : 29]);
markerPlotX{curPlotIndex} = dataPlotX{curPlotIndex}(curSteps);
markerPlotY{curPlotIndex} = dataPlotY{curPlotIndex}(curSteps);
markerType{curPlotIndex}= 'v';
markerColor{curPlotIndex} = 'b';
...
curSteps = findClosest(dataPlotX{curPlotIndex}, [.8, 2.5 :  7.5 : 29]);
markerPlotX{curPlotIndex} = dataPlotX{curPlotIndex}(curSteps);
markerPlotY{curPlotIndex} = dataPlotY{curPlotIndex}(curSteps);
markerType{curPlotIndex}= 'd';
markerColor{curPlotIndex} = 'b';
...
ylabel('lower bounds');
xlabel('time (seconds)');
title('SMR and DD-TRW lower bounds for image segmentation instances');
...
ylabel('energies');
xlabel('time (seconds)');
title('SMR and DD-TRW energies for image segmentation instances');
